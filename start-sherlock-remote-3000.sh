#!/bin/bash
# Start Sherlock Visage for remote access (Port 3000)

echo "🚀 Starting Sherlock Visage for remote access (Port 3000)..."
...
# Start frontend dev server on all interfaces (Port 3000)
echo "🎨 Starting frontend dev server on port 3000..."
cd /home/tendayi/Hermes-Amara/sherlock-visage
npm run dev -- --host 0.0.0.0 --port 3000 &
FRONTEND_PID=$!
echo "Frontend started (PID: $FRONTEND_PID) on 0.0.0.0:3000"
...
echo "  ssh -L 3000:localhost:3000 -L 8000:localhost:8000 tendayi@$(hostname -I | awk '{print $1}')"
